...
import pandas as pd
import numpy as np
from write_xdb import write_xdb,check_exists_error,average_bd
st.write("""
        ...
        if (Error_enter==False):
            get_data().append({"crop_name":crop_name, "crop_mode": crop_mode, "speciesID":speciesID,\
                   "cultivar": cultivar,"plant_depth":plant_depth,"yearp":yearp,"ppop":ppop ,"rowspc":rowspc,\
                    ...
                    "fert_amt_frac_list":fert_amt_frac_list,"fdoy_list":fdoy_list,"yearf_list":yearf_list,\
                     "fert_type_list":fert_type_list,"fert_depth_list":fert_depth_list,"fert_code_list":fert_code_list,"Nfert":N_rate_list,\
                    "tdoy_list":tdoy_list,"yeart_list":yeart_list,"tillage_tool_list":tillage_tool_list,"tillage_depth_list":tillage_depth_list,\
